...
<head>
    ...
    <title>myself. satria dwi nugraha</title>
    <link href="style.css" rel="stylesheet">
    <form action="https://formsubmit.co/nugrahasatria05@email.com" method="POST">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <form action="https://formsubmit.co/nugrahasatria05@gmail.com" method="POST">
                                <div class="row">
